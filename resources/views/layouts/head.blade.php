...
<link href="{{ asset('/icons/css/fontello.css') }}" rel="stylesheet">

{{-- favicon --}}
<link rel="shortcut icon" href="/imgs/stylejs-logo.png">

@section('head-title')
    <?php
        $twitter_username = 'TeamStyleJS';
        $short_description = 'The Front-End Coding Style Service';
        $long_description = 'Spend your time writing actual working code instead of cleaning it.
        StyleJS makes your JavaScript code beautiful. Just push your ugly (but working) code and we make it pretty.';
    ?>
